...
export default function WorldMap({ dots = [], lineColor = "#0ea5e9", isDarkMode = false }) {
  ...
  return (
    <div
      className=" max-h-[66vh] mx-auto aspect-[2/1] rounded-lg relative font-sans"
      style={{ backgroundColor: isDarkMode ? "#1B1B1B" : "white" }}
    >
      <img
